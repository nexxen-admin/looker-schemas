view: sno_fce_atv_fdp_data_prod {
  derived_table: {
    sql: select t.iid, t.data_vals:start_date_time::string as start_date_time, count(*) as count, sum(t.data_vals:requests::int) as sum_requests from PROD.FCE_ATV_FDP_DATA.DATA as t group by t.iid, t.data_vals:start_date_time::string;;
  }
