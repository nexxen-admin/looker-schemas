view: monthly_viewer_rta_group {
  derived_table: {
    sql: select rta_group_id,
      ...
      measure: weekly_effective_weight {
        label: "Monthly RTA Effective Weight"
        view_label: "Monthly"
        type: sum
  ...
  dimension: timeperiod_date_key {
    type: number
    #hidden: yes
    label: "Monthly RTA Weight Timeperiod"
    view_label: "Monthly"
    description: "The timeperiod for which the RTA group was effective.  This will be in the form of yyyymm where mm is the month of the year."
    ...
    value_format_name: id
      ...
      dimension_group: end_effective {
        type: time
        label: "Monthly RTA Effective End Date"
        view_label: "Dates"
        hidden: yes
        timeframes: [
          raw,
      ...
      dimension_group: start_effective {
        type: time
        label: "Monthly RTA Effective Start Date"
        view_label: "Dates"
        hidden: yes
        timeframes: [
          raw,
