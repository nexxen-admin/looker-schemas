# The name of this view in Looker is "V Dim Placement Group"
view: v_dim_placement_group {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: BI_TVDSP.V_Dim_Placement_Group ;;
  ...
  # This dimension will be called "Placement Group ID" in Explore.
  ...
  dimension: placement_group_name {
    type: string
    sql: ${TABLE}.Placement_Group_Name ;;
  }
