view: v_raw_impression {
  ...
  dimension: age {
    ...
    label: "Age"
    hidden: no
    sql: ${v_attribute_lookup_languageid.description} ;;
  }
  ...
  dimension: dst_epoch_raw_date {
    ...
    sql: case when ${v_platform_client.use_daylight_saving} then ${TABLE}.EPOCH_NUMBER::timestamp_ntz AT TIME ZONE 'UTC' AT TIME ZONE ${v_timezone.timezone_name}
  ...
  dimension_group: dst_eventtime {
    ...
    view_label: "Raw Impression Dates"
    sql: case when ${v_platform_client.use_daylight_saving} then ${TABLE}.EVENTTIME AT TIME ZONE 'UTC' AT TIME ZONE ${v_timezone.timezone_name}
  ...
  dimension: gender {
    ...
    label: "Gender"
    hidden: no
    sql: ${v_attribute_lookup_genderid.description}  ;;
  }
  ...
  dimension_group: dst_keydate {
    ...
    sql: case when ${v_platform_client.use_daylight_saving} then ${TABLE}.KEYDATE AT TIME ZONE 'UTC' AT TIME ZONE ${v_timezone.timezone_name}
...
# ID >> needs view
  ...
  dimension: placement {
    ...
    sql: CASE WHEN ${v_placement_details_base.placement_inventory_type} IN('Private Exchange', 'Exchange') THEN ${v_placement_details_base.placement_name} ELSE CONCAT('Placement - ', ${TABLE}.placement_id) END ;;
  }
  ...
  dimension: placement_transparent {
    ...
    sql: ${v_placement_details_base.placement_name} ;;
  }
  ...
  dimension: publisher {
    ...
    sql: CASE WHEN ${v_placement_details_base.placement_inventory_type} IN('Private Exchange', 'Exchange') THEN ${v_placement_details_base.partner_name} ELSE CONCAT('Partner - ', ${v_placement_details_base.partner_id} * 2) END ;;
  }
  ...
  dimension: publisher_transparent {
    ...
    sql: ${v_placement_details_base.partner_name} ;;
  }
  ...
  measure: grp {
    ...
    sql: (${sum_billable_impressions} / max(${v_flight_media_details_base.demoaud})) * 100 ;;
  }
  ...
  measure: trp {
    ...
    sql:  (${sum_effective_impressions} / (max(${v_flight_media_details_base.demoaud}) * max(${v_flight_media_details_base.democomp}))) * 100 ;;
  }
  ...
  measure: data_price{
    ...
    sql: ${sum_demand_bt_cluster_cost} + ${sum_demand_demo_provider_cost} + ${v_bt_cost_attributes.sum_demand_bt_provider_cost};;
  }
  ...
  dimension: revenue_cpu_usd {
    ...
    sql: ${TABLE}.REVENUE_CPU * ${v_hourly_exchange_rates.exchange_rate} ;;
