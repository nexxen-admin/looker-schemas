view: fact_target_forecast_strategy_summary {
  ...
  dimension: Strat_Sales_Team {
    type: string
    sql: CASE WHEN ${TABLE}.seller='TBH - West 2' THEN 'Strat Sales - Haddow'
    WHEN ${TABLE}.seller='TBH - West 1' THEN 'Strat Sales - Doherty'
  ...
  dimension: Strat_Sales_RVP {
    ...
    WHEN ${TABLE}.seller IN ('TBH - West 1' , 'TBH - West 2') THEN 'Strat Sales - West'
