          ...
          , combined as (
            select cr.Event_Date
             ...
             select 'WEEK' as Metric_Type
                 ...
                 , sum(Cost_New) as Cost_New
             from combined
             where Event_Date >= (CASE WHEN {% parameter Report_Run_Date %} IS NULL THEN CURRENT_DATE - INTERVAL '1 DAY' ELSE {% parameter Report_Run_Date %} END)::DATE - INTERVAL '6 DAYS' AND Event_Date <= {% parameter Report_Run_Date %}
             group by Event_Date
                 , Region
                 , Category
                 , Subcategory
            ...
            UNION
             select 'MTD' as Metric_Type
                 ...
                 , sum(Cost_New) as Cost_New
             from combined
             where Event_Date >= DATE_TRUNC('month', (CASE WHEN {% parameter Report_Run_Date %} IS NULL THEN CURRENT_DATE - INTERVAL '1 DAY' ELSE {% parameter Report_Run_Date %} END)::DATE)::date AND Event_Date <= {% parameter Report_Run_Date %}
             group by Event_Date
                 , Region
                 , Category
                 , Subcategory
            ...
            UNION
             select 'QTD' as Metric_Type
                 ...
                 , sum(Cost_New) as Cost_New
             from combined
             where Event_Date >= DATE_TRUNC('quarter', (CASE WHEN {% parameter Report_Run_Date %} IS NULL THEN CURRENT_DATE - INTERVAL '1 DAY' ELSE {% parameter Report_Run_Date %} END)::DATE)::date AND Event_Date <= {% parameter Report_Run_Date %}
             group by Event_Date
                 , Region
                 , Category
                 , Subcategory
            ...
            UNION
             select 'YTD' as Metric_Type
                 ...
                 , sum(Cost_New) as Cost_New
             from combined
             where Event_Date >= DATE_TRUNC('year', (CASE WHEN {% parameter Report_Run_Date %} IS NULL THEN CURRENT_DATE - INTERVAL '1 DAY' ELSE {% parameter Report_Run_Date %} END)::DATE)::date AND Event_Date <= {% parameter Report_Run_Date %}
             group by Event_Date
                 , Region
                 , Category
                 , Subcategory
