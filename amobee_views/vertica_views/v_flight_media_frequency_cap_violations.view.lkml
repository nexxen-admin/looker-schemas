view: v_flight_media_frequency_cap_violations {
      ...
      SELECT
        ...
        FROM
          (
            ...
            LEFT JOIN dim.frequency_cap_view fc ON fc.level = 5 AND fc.ref_id = r1.flight_media_id AND r1.eventtime >= fc.start_time and r1.eventtime < coalesce(fc.end_time, TO_TIMESTAMP('9999-12-12', 'YYYY-MM-DD'))
            LEFT JOIN rawdb.raw_impression r2 ON r1.userid = r2.userid AND r1.flight_media_id = r2.flight_media_id
  ...
  dimension: max_exposures {
    label: "Flight Media Level Frequency Cap"
  ...
  dimension: exposure_minutes{
    label: "Flight Media Level Frequency Cap Period (in minutes)"
    view_label: "Flight Media"
    type: number
  ...
  measure: sum_of_violations {
    type: sum
    label: "Flight Media Level Frequency Cap Violations"
    view_label: "Flight Media"
    sql: ${is_violation} ;;
  }

  measure: pct_of_violations {
    label: "% of Flight Media Level Frequency Cap Violations"
    type: number
