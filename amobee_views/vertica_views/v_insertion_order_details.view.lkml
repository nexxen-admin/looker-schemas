view: v_insertion_order_details {
  ...
  dimension: insertion_order_name {
    ...
    drill_fields: [v_campaign_details_base.plan_name, v_campaign_details_base.campaign_name, v_flight_details.flight_description, v_flight_media_details_base.media_name, v_flight_media_details_base.flight_media_id]
    suggest_explore: suggest_demand_ref
  ...
  dimension: dst_io_begin_date {
    ...
    sql: case when ${v_platform_client.use_daylight_saving} then ${TABLE}.IO_BEGIN_DATE AT TIME ZONE 'UTC' AT TIME ZONE ${v_timezone.timezone_name}
