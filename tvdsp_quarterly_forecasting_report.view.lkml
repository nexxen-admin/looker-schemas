view: tvdsp_quarterly_forecasting_report {
  derived_table: {
    sql: /*Begin data extraction query*/

      WITH /*+ENABLE_WITH_CLAUSE_MATERIALIZATION */ Salesforce_Meta_Data AS(
      ...
      SELECT 'Tremor MS' as Classification,
