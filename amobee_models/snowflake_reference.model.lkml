...
# explore: v_monthly_exchange_rate{
...
#   join: v_demand_mart_load_tracking {
#     relationship: many_to_one
#     sql_on: ${v_campaign_details_base.timezone_id} = ${v_demand_mart_load_tracking.start_timezone} and
...
# explore: v_marketplace_login_history_view {
#   required_access_grants: [can_use_explore]
...
#   access_filter: {
#     field: v_suggest_demand_ref.country_id
...
#   access_filter: {
#     field: v_suggest_supply_ref.placement_country_id
#     user_attribute: access_filter_country_id
#   }
