# The name of this view in Looker is "V Dim Advertiser"
view: v_dim_advertiser {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: BI_TVDSP.V_Dim_Advertiser ;;
  ...
  measure: total_advertiser_key {
    type: sum
    sql: ${advertiser_key} ;;
  }

  measure: average_advertiser_key {
    type: average
    sql: ${advertiser_key} ;;
  }
