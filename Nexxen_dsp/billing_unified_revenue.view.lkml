view: billing_unified_revenue {
  sql_table_name: BI_DSP.billing_unified_revenue ;;
  ...
  dimension: locked_1p_impressions {
    type: number
    sql: ${TABLE}.locked_1p_impressions ;;
  }

  measure: sum_locked_1p_impressions {
    type: sum
    label: "Locked 1P Impressions"
    sql: ${TABLE}.locked_1p_impressions ;;
  }
