      ...
      WITH _DATE_DIM AS (
        ...
        (
          SELECT
            ...
            CAST(DATEDIFF('SECOND', GREATEST(MIN(fd.BEGIN_DATETIME_LOCAL), dd.DATE), LEAST(MAX(fd.END_DATETIME_LOCAL), DATEADD('DAY', 1, dd.DATE))) AS FLOAT) AS ELAPSED_TIME,
        ...
        FROM
          RAWDB.DAILY_CORE_STATS_ON_ANALYTICS s
