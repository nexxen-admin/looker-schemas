view: fact_nexxen_dsp_ncd_perf_test {
    # The sql_table_name parameter indicates the underlying database table
    # to be used for all fields in this view.
    sql_table_name: BI_DSP.fact_neexen_dsp_ncd_perf_test ;;
  ...
  dimension: region_key {
    ...
    measure: Delivered_Spend {
      type: sum
      sql: ${TABLE}.impressions/1000*${dim_sfdb_opportunitylineitem_ncd_perf.rate__c};;
      value_format: "$#,##0.00"
    }
