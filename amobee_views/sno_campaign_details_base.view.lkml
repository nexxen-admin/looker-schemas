...
#    hidden: yes
  ...
  dimension: dst_plan_start_date {
    ...
    sql: case when ${platform_client.use_daylight_saving} then convert_timezone('UTC', ${timezone.timezone_name}, ${TABLE}.PLAN_START_DATE)
  ...
  measure: agency_fee {
    ...
    sql: ${flight_media_details_base.agency_fee} ;;
  }
