...
explore: fact_nexxen_dsp  {
  ...
  join: v_dim_netsuite_daily_exchange_rate_target_currency {
    ...
    sql_on: ${v_dim_netsuite_daily_exchange_rate_target_currency.exchange_rate_to_target_currency_key}=${fact_nexxen_dsp.exchange_rate_to_target_currency_key} ;;
    relationship: many_to_one
  }
  ...
  join: v_dim_netsuite_daily_exchange_rate_usd_currency {
    ...
    sql_on: ${v_dim_netsuite_daily_exchange_rate_usd_currency.exchange_rate_to_usd_currency_key}=${fact_nexxen_dsp.exchange_rate_to_usd_currency_key} ;;
    relationship: many_to_one
  }
