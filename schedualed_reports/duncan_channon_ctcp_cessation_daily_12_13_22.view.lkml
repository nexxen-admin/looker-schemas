view: duncan_channon_ctcp_cessation_daily_12_13_22 {
  ...
  derived_table: {
    sql: SELECT Date_Key::date as "date",
           ...
           CASE WHEN Flight_ID = 4518316 AND Creative_ID = 8695486 THEN 'DC_CTCP_2022_Q4_CESSATION_MC_EN_TREMOR_STATEWIDE_VIDEO_CTV_INCITE_CPM_1x1_PREDICTIVE_SMOKERS-21+_30S__STEVEN_'
                 WHEN Flight_ID = 4518316 AND Creative_ID = 8695476 THEN 'DC_CTCP_2022_Q4_CESSATION_MC_EN_TREMOR_STATEWIDE_VIDEO_CTV_INCITE_CPM_1x1_PREDICTIVE_SMOKERS-21+_30S__GEORGE_'
                 WHEN Flight_ID = 4518306 THEN 'DC_CTCP_2022_Q4_CESSATION_MC_EN_TREMOR_STATEWIDE_VIDEO_CTV_INCITE_CPM_1x1_PREDICTIVE_VAPERS-18-24_30S__RYAN_'
           ...
           CASE WHEN Flight_ID = 4518316 AND Creative_ID = 8695486  THEN '353538113'
                 WHEN Flight_ID = 4518316 AND Creative_ID = 8695476  THEN '353538116'
                 WHEN Flight_ID = 4518306 THEN '353894463'
