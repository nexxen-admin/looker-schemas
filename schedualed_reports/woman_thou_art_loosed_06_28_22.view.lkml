view: woman_thou_art_loosed_06_28_22 {
  ...
  derived_table: {
    sql: SELECT date::date as "Date",
           ...
           CASE WHEN c.flight_number IN ('F-288405', 'F-288123', 'F-288404', 'F-288406') THEN (SUM(impressions)/1000)*25
      ...
      WHERE date >= '2022-06-15'
        ...
        AND add2.flight_id IN (4351986, 4351996, 4352006, 4352016, 4352026, 4352056, 4352086, 4352096)
