view: fact_ad_daily_agg {
  ...
  measure: impression_variable {
    ...
    <div style="border-radius: 10px;box-shadow: inset 4.33643px -4.33643px 4.33643px; background-color: #fff; color: #010e0f;">
        ...
        <div style=font-size: "10px;" <span class="vis-single-value-comparison-value positive">▲ <span class="drillable-item" data-links="" data-context="" data-add-filter-json=""><span class="drillable-item-content">$10%</span></span></span></div>
