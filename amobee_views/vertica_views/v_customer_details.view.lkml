view: v_customer_details {
  ...
  dimension: customer_name {
    ...
    drill_fields: [v_advertiser_brand_details.advertiser_name, v_advertiser_brand_details.brand_name, v_insertion_order_details.insertion_order_name]
    suggest_explore: suggest_demand_ref
  ...
  measure: count {
    type: count
    drill_fields: [customer_name, customer_group_name, v_country.country_id]
  }
}
