connection: "vertica_read_only_test"
...
explore: fact_ad_daily_agg{
  ...
  label: "Inbound Exchange - RO TEST"
  view_label: "Measures"
  ...
  join: dim_employee {
    type: full_outer
    view_label: "Employee"
    sql_on: ${dim_employee.employee_key}=${dim_publisher.bizdev_owner_key} or
      ${dim_employee.employee_key}=${dim_publisher.ops_owner_key};;
    relationship: many_to_one
  }
