# The name of this view in Looker is "V Dim Video Linearity"
view: dim_video_linearity {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: BI_New.V_Dim_Video_Linearity ;;
  ...
  dimension: video_linearity_id {
    type: string
    sql: ${TABLE}.Video_Linearity ;;
    hidden: yes
  }
  ...
  measure: total_video_linearity_key {
    type: sum
    sql: ${video_linearity_key} ;;
    hidden: yes
  }

  measure: average_video_linearity_key {
    type: average
    sql: ${video_linearity_key} ;;
    hidden: yes
  }
