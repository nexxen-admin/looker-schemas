  ...
  derived_table: {
    sql:
      ...
      JOIN VIEWERSHIP.VIEWER_RTA_GROUP rta
       ...
       GROUP BY {% if sno_m_viewer_equi_imps.network._in_query and sno_m_viewer_equi_imps.daypart._in_query == false and sno_m_viewer_equi_imps.program._in_query == false %} mc.media_content_parent {% endif %}
          {% if sno_m_viewer_equi_imps.daypart._in_query
            and sno_m_viewer_equi_imps.network._in_query == false
            and sno_m_viewer_equi_imps.program._in_query == false %} mc.media_daypart_id {% endif %}
          {% if sno_m_viewer_equi_imps.program._in_query
            and sno_m_viewer_equi_imps.network._in_query == false
            and sno_m_viewer_equi_imps.daypart._in_query == false %}  mc.media_content_name {% endif %}
          {% if sno_m_viewer_equi_imps.network._in_query
            and sno_m_viewer_equi_imps.daypart._in_query
            and sno_m_viewer_equi_imps.program._in_query == false %}  mc.media_content_parent, mc.media_daypart_id {% endif %}
          {% if sno_m_viewer_equi_imps.network._in_query
            and sno_m_viewer_equi_imps.program._in_query
            and sno_m_viewer_equi_imps.daypart._in_query == false %} mc.media_content_parent, mc.media_content_name {% endif %}
          {% if sno_m_viewer_equi_imps.daypart._in_query
            and sno_m_viewer_equi_imps.program._in_query
            and sno_m_viewer_equi_imps.network._in_query == false %} mc.media_daypart_id, mc.media_content_name {% endif %}
          {% if sno_m_viewer_equi_imps.network._in_query
            and sno_m_viewer_equi_imps.daypart._in_query
            and sno_m_viewer_equi_imps.event_date._in_query == false
            and sno_m_viewer_equi_imps.program._in_query %} mc.media_content_parent, mc.media_daypart_id, mc.media_content_name {% endif %}
          {% if sno_m_viewer_equi_imps.network._in_query
            and sno_m_viewer_equi_imps.daypart._in_query
            and sno_m_viewer_equi_imps.event_date._in_query
            and sno_m_viewer_equi_imps.program._in_query %} vf.event_date, mc.media_content_parent, mc.media_daypart_id, mc.media_content_name {% endif %}
       ;;
  }
    ...
    sql:  {% if sno_m_viewer_equi_imps.network._in_query
      ...
      or sno_m_viewer_equi_imps.program._in_query %}{% else %} TRUE {% endif%}
          ...
          {% if sno_m_viewer_equi_imps.network._in_query
            ...
            and sno_m_viewer_equi_imps.event_date._in_query == false
            and sno_m_viewer_equi_imps.program._in_query == false %} ${network} {% endif %}

          {% if sno_m_viewer_equi_imps.daypart._in_query
            and sno_m_viewer_equi_imps.network._in_query == false
            and sno_m_viewer_equi_imps.event_date._in_query == false
            and sno_m_viewer_equi_imps.program._in_query == false %} ${daypart} {% endif %}

          {% if sno_m_viewer_equi_imps.program._in_query
            and sno_m_viewer_equi_imps.network._in_query == false
            and sno_m_viewer_equi_imps.event_date._in_query == false
            and sno_m_viewer_equi_imps.daypart._in_query == false %} ${program} {% endif %}

          {% if sno_m_viewer_equi_imps.event_date._in_query
            and sno_m_viewer_equi_imps.network._in_query == false
            and sno_m_viewer_equi_imps.program._in_query == false
            and sno_m_viewer_equi_imps.daypart._in_query == false %} ${event_date} {% endif %}

          {% if sno_m_viewer_equi_imps.network._in_query
            and sno_m_viewer_equi_imps.daypart._in_query
            and sno_m_viewer_equi_imps.event_date._in_query == false
            and sno_m_viewer_equi_imps.program._in_query == false %} ${network}||${daypart} {% endif %}

          {% if sno_m_viewer_equi_imps.network._in_query
            and sno_m_viewer_equi_imps.program._in_query
            and sno_m_viewer_equi_imps.event_date._in_query == false
            and sno_m_viewer_equi_imps.daypart._in_query == false %} ${network}||${program} {% endif %}

          {% if sno_m_viewer_equi_imps.daypart._in_query
            and sno_m_viewer_equi_imps.program._in_query
            and sno_m_viewer_equi_imps.event_date._in_query == false
            and sno_m_viewer_equi_imps.network._in_query == false %} ${daypart}||${program} {% endif %}

          {% if sno_m_viewer_equi_imps.event_date._in_query
            and sno_m_viewer_equi_imps.program._in_query
            and sno_m_viewer_equi_imps.daypart._in_query == false
            and sno_m_viewer_equi_imps.network._in_query == false %} ${event_date}||${program} {% endif %}

          {% if sno_m_viewer_equi_imps.event_date._in_query
            and sno_m_viewer_equi_imps.network._in_query
            and sno_m_viewer_equi_imps.daypart._in_query == false
            and sno_m_viewer_equi_imps.program._in_query == false %} ${event_date}||${network} {% endif %}

          {% if sno_m_viewer_equi_imps.event_date._in_query
            and sno_m_viewer_equi_imps.daypart._in_query
            and sno_m_viewer_equi_imps.network._in_query == false
            and sno_m_viewer_equi_imps.program._in_query == false %} ${event_date}||${daypart} {% endif %}
