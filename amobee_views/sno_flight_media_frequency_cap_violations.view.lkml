view: flight_media_frequency_cap_violations {
      ...
      SELECT
        ...
        FROM
          (
            ...
            LEFT JOIN dim.frequency_cap fc ON fc.level = 5 AND fc.ref_id = r1.flight_media_id AND r1.eventtime >= fc.start_time and r1.eventtime < coalesce(fc.end_time, to_date('9999-12-12'))
            LEFT JOIN rawdb.raw_impression_v2 r2 ON r1.userid = r2.userid AND r1.flight_media_id = r2.flight_media_id
