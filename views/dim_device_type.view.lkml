view: dim_device_type {
  ...
  dimension: device_type {
    ...
    drill_fields: [dim_buying_channel.buying_channel, dim_dsp.dsp_display_name, dim_a_domain.a_domain, dim_o_domain.o_domain, dim_placement.media_type, dim_imp_type.imp_type]
