view: v_daily_ccp_metrics {
  ...
  measure: exp_rev {
    ...
    sql: ${daily_ccp_eoc_audit}/1000 * COALESCE((${v_campaign_demand_units_budget.budget}/NULLIF(${v_campaign_demand_units_budget.campaign_delivery_units},0)) * 1000,0) ;;
  }
  ...
  measure: daily_ccp_eoc_audit_diff_yesterday_gmt {
    ...
    value_format: "#,##0;(#,##0)"
    sql: coalesce(${v_daily_core_stats.sum_billable_units_yesterday_gmt}, 0) - coalesce(${sum_daily_ccp_eoc_audit_yesterday}, 0) ;;
  }
