view: v_advertiser_brand_details {
  label: "Brand"
  ...
  dimension: advertiser_name {
    ...
    drill_fields: [brand_name, v_campaign_details_base.campaign_name, v_flight_details.flight_description, v_flight_media_details_base.media_name, v_flight_media_details_base.flight_media_id ]
  ...
  dimension: brand_name {
    ...
    drill_fields: [v_campaign_details_base.campaign_name, v_flight_details.flight_description, v_flight_media_details_base.media_name, v_flight_media_details_base.flight_media_id ]
    suggest_explore: suggest_demand_ref
