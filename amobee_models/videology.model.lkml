...
explore: v_hourly_analytics {
  ...
  sql_always_where: ({% if _user_attributes['access_filter_office_id'] == '>=0, NULL' %} TRUE {% else %} (${v_platform_client.office_id} IN ({{ _user_attributes['access_filter_office_id'] }}) OR ${v_supply_platform_client.office_id} IN ({{ _user_attributes['access_filter_office_id'] }})) {% endif %}) AND
                    ...
                    ({% if _user_attributes['access_filter_include_platform_client_id'] == 'NULL' %} TRUE {% else %} ( ${v_campaign_details_base.platform_client_id} IN ({{ _user_attributes['access_filter_include_platform_client_id'] }})) OR (${v_placement_details_base.platform_client_id} IN ({{ _user_attributes['access_filter_include_platform_client_id'] }})) {% endif %}) ;;
...
#     sql_on:{% if sno_frequency_by_tier.campaign_id._in_query %} ${v_frequency_by_tier.campaign_id} = ${v_campaign_details_base.campaign_id}
#     {% elsif sno_frequency_by_tier.plan_id._in_query %} ${v_sno_frequency_by_tier.plan_id} = ${v_campaign_details_base.pl_plan_id} {% endif %} ;;
#   }
...
#   sql_always_where: ({% if _user_attributes['access_filter_office_id'] == '>=0, NULL' %} TRUE {% else %} (${v_platform_client.office_id} IN ({{ _user_attributes['access_filter_office_id'] }})) {% endif %}) AND
#   ({% if _user_attributes['access_filter_platform_client_id'] == '>=0, NULL' %} TRUE {% else %} (${v_campaign_details_base.platform_client_id} IN ({{ _user_attributes['access_filter_platform_client_id'] }}))) OR (${v_platform_client.platform_client_id} IN ({{ _user_attributes['access_filter_platform_client_id'] }})) {% endif %}) AND
...
#   join: v_sno_campaign_target {
#     relationship: one_to_many
#     sql_on: ${v_retargeting_attribute.retargeting_attribute_id} = ${v_sno_campaign_target.attribute_value_id} ;;
#   }

#   join: v_campaign_details_base {
#     relationship: many_to_one
#     sql_on: ${v_sno_campaign_target.campaign_id} = ${v_campaign_details_base.campaign_id} ;;
#   }
...
#   join: v_sno_attribute_value_metrics {
#     relationship: one_to_many
#     sql_on: ${v_retargeting_attribute.retargeting_attribute_id} = ${v_sno_attribute_value_metrics.attribute_value_id}
#       AND ${v_sno_attribute_value_metrics.attribute_id} = 20 ;;
#   }

#   join: v_sno_attribute_value_metrics_country {
#     relationship: many_to_one
#     sql_on: ${v_sno_attribute_value_metrics.country_id} = ${v_sno_attribute_value_metrics_country.country_id};;
#   }
# }
...
#   join: v_demand_mart_load_tracking {
#     relationship: many_to_one
#     sql_on: ${v_flight_media_details_base.starttimezone_id} = ${v_demand_mart_load_tracking.start_timezone} and
#       ${v_demand_mart_load_tracking.schema_name} = 'demand_mart' and
#       ${v_demand_mart_load_tracking.table_name} = 'daily_core_stats' ;;
#   }
...
#   join: v_campaign_details_base {
#     relationship: many_to_one
#     sql_on: ${v_campaign_details_base.campaign_id} = ${v_tpm_metrics.campaign_id} ;;
#   }
...
#   join: v_campaign_days {
#     relationship: many_to_one
#     sql_on: ${v_tpm_metrics.campaign_id} = ${v_campaign_days.campaign_id} ;;
#   }

#   join: v_placement_details_base {
#     relationship: many_to_one
#     sql_on: ${v_placement_details_base.placement_id} = ${v_tpm_metrics.placement_id}  ;;
#   }
...
#   join: v_campaign_details_base {
#     relationship: many_to_one
#     sql_on: ${v_portfolio_trends.campaign} = ${v_campaign_details_base.campaign_id} ;;
#   }
...
# explore: v_daily_campaign_retargeting_stats {
#   required_access_grants: [can_use_explore]
...
#   join: v_campaign_details_base {
#     relationship: many_to_one
#     sql_on: ${v_campaign_details_base.campaign_id} = ${v_daily_campaign_retargeting_stats.campaign_id} ;;
#   }
...
#   join: v_retargeting_attribute {
#     relationship: many_to_one
#     sql_on: ${v_daily_campaign_retargeting_stats.retargeting_attribute_id} = ${v_retargeting_attribute.retargeting_attribute_id} ;;
#   }
...
# explore: v_sno_demand_raw_impression_validation {
#   required_access_grants: [can_use_explore]
...
#   join: v_timezone {
#     relationship: many_to_one
#     sql_on: ${v_sno_demand_raw_impression_validation.timezone_id} = ${v_timezone.timezone_id} ;;
#   }

#   join: v_sno_demand_validation {
#     relationship: one_to_many
#     sql_on:
#       ${v_sno_demand_raw_impression_validation.demand_date} = ${v_sno_demand_validation.demand_date}
#       AND ${v_sno_demand_raw_impression_validation.timezone_id} = ${v_sno_demand_validation.timezone_id};;
#   }
# }

# explore: v_sno_supply_raw_impression_validation {
#   required_access_grants: [can_use_explore]
...
#   join: v_timezone {
#     relationship: many_to_one
#     sql_on: ${v_sno_supply_raw_impression_validation.timezone_id} = ${v_timezone.timezone_id} ;;
#   }

#   join: v_sno_supply_validation {
#     relationship: one_to_many
#     sql_on:
#       ${v_sno_supply_raw_impression_validation.supply_date} = ${v_sno_supply_validation.supply_date}
#       AND ${v_sno_supply_raw_impression_validation.timezone_id} = ${v_sno_supply_validation.timezone_id};;
#   }
# }

# explore: v_demand_warehouse_validation {

#   label: "Demand Warehouse Validation"
#   hidden: yes
# }

# explore: v_supply_warehouse_validation {
...
#   sql_always_where: ({% if _user_attributes['access_filter_include_platform_client_id'] == 'NULL' %} TRUE {% else %} (${v_suggest_demand_ref.platform_client_id} IN ({{ _user_attributes['access_filter_include_platform_client_id'] }})) {% endif %}) ;;

#   hidden: yes
# }

# explore: v_suggest_supply_ref {
...
#   sql_always_where: ({% if _user_attributes['access_filter_include_platform_client_id'] == 'NULL' %} TRUE {% else %} (${v_suggest_supply_ref.platform_client_id} IN ({{ _user_attributes['access_filter_include_platform_client_id'] }})) {% endif %}) ;;

#   hidden: yes
# }

# explore: v_sno_load_tracking_whse_validation {
#   required_access_grants: [can_use_explore]
#   label: "Load tracking warehouse validation"
#   view_name: v_timezone

#   join: v_sno_demand_load_tracking_whse_validation {
#     relationship: one_to_many
#     sql_on: ${v_timezone.timezone_id} = ${v_sno_demand_load_tracking_whse_validation.start_timezone} ;;
#   }

#   join: v_sno_supply_load_tracking_whse_validation {
#     relationship: one_to_many
#     sql_on: ${v_timezone.timezone_id} = ${v_sno_supply_load_tracking_whse_validation.start_timezone} ;;
#   }
# }

# explore: v_sno_sas_monitoring {
#   required_access_grants: [can_use_explore]
#   label: "SAS forecasting monitoring"
#   view_name: v_sno_fce_atv_fdp_data_prod

#   join: v_sno_fce_atv_fdp_data_itv {
#     relationship: many_to_many
#     sql_on: ${v_sno_fce_atv_fdp_data_prod.start_date_time} = ${v_sno_fce_atv_fdp_data_itv.start_date_time};;
#   }

#   join: v_sno_fce_atv_fdp_data_sbx {
#     relationship: many_to_many
#     sql_on: ${v_sno_fce_atv_fdp_data_prod.start_date_time} = ${v_sno_fce_atv_fdp_data_sbx.start_date_time};;
#   }
# }

# explore: v_fce_atv_fdp_forecasts_data {
...
#   always_join: [v_fce_atv_fdp_forecasts_info] # important for access limiting



#   join: v_fce_atv_fdp_forecasts_info {
#     relationship: many_to_one
#     type: inner # important for access limiting
#     sql_on: ${v_fce_atv_fdp_forecasts_data.iid} = ${v_fce_atv_fdp_forecasts_info.iid} ;;
#   }

#   join: v_fce_atv_fdp_data_attr {
#     relationship: many_to_one
#     sql_on: ${v_fce_atv_fdp_forecasts_data.pool_id} = ${v_fce_atv_fdp_data_attr.pool_id} ;;
#   }
# }

# explore: v_sno_opt_viewing_spot_level_pacing {
#   required_access_grants: [can_use_explore]
#   label: "OPT Pacing"
#   sql_always_where: ({% if _user_attributes['access_filter_office_id'] == '>=0, NULL' %} TRUE {% else %} (${v_platform_client.office_id} IN ({{ _user_attributes['access_filter_office_id'] }})) {% endif %}) AND
#   ({% if _user_attributes['access_filter_platform_client_id'] == '>=0, NULL' %} TRUE {% else %} (${v_campaign_details_base.platform_client_id} IN ({{ _user_attributes['access_filter_platform_client_id'] }}))) OR (${v_platform_client.platform_client_id} IN ({{ _user_attributes['access_filter_platform_client_id'] }})) {% endif %}) AND
#   ({% if _user_attributes['access_filter_include_platform_client_id'] == 'NULL' %} TRUE {% else %} ( ${v_campaign_details_base.platform_client_id} IN ({{ _user_attributes['access_filter_include_platform_client_id'] }})) AND (${v_platform_client.platform_client_id} IN ({{ _user_attributes['access_filter_include_platform_client_id'] }})) {% endif %})
#   AND {% if sno_opt_viewing_spot_level_pacing.show_only_latest_report._parameter_value == "latest_any" or sno_opt_viewing_spot_level_pacing.show_only_latest_report._parameter_value == "latest_approved" %} ${v_sno_opt_viewing_spot_level_pacing_latest_report.campaign_id} IS NOT NULL {% else %} TRUE {% endif %}
#     AND {% if sno_opt_viewing_spot_level_pacing.show_only_latest_report._parameter_value == "latest_approved" %} ${v_sno_opt_pacing_report_approval.approval_state} = 'approved' {% else %} TRUE {% endif %} ;;


#   fields: [ALL_FIELDS*,-campaign_details_base.agency_fee]

#   join: v_sno_opt_pacing_report_approval {
#     relationship: many_to_one
#     sql_on: ${v_sno_opt_viewing_spot_level_pacing.report_id} = ${v_sno_opt_pacing_report_approval.report_id} ;;
#   }

#   join: v_sno_opt_viewing_spot_level_pacing_latest_report {
#     relationship: many_to_one
#     type: inner
#     sql_on: ${v_sno_opt_viewing_spot_level_pacing.campaign_id} = ${v_sno_opt_viewing_spot_level_pacing_latest_report.campaign_id} AND ${v_sno_opt_viewing_spot_level_pacing.run_raw} = ${v_sno_opt_viewing_spot_level_pacing_latest_report.latest_run_date} ;;
#   }

#   join: v_sno_converged_approved_campaigns {
#     relationship: many_to_one
#     sql_on: ${v_sno_opt_viewing_spot_level_pacing.campaign_id} = ${v_sno_converged_approved_campaigns.campaign_id} and ${v_sno_converged_approved_campaigns.approved_campaign_status} in (3,4) ;;
#   }

#   join: v_campaign_details_base {
#     relationship: many_to_one
#     sql_on: ${v_sno_opt_viewing_spot_level_pacing.campaign_id} = ${v_campaign_details_base.campaign_id} ;;
#   }
...
#   join: v_flight_media_details_base {
#     relationship: many_to_one
#     sql_on: ${v_flight_details.flight_id} = ${v_flight_media_details_base.flight_id} ;;
#     fields: []
#   }
...
#   join: v_sno_validation_report_result {
#     relationship: many_to_many
#     sql_on: ${v_sno_opt_viewing_spot_level_pacing.report_id} = ${v_sno_validation_report_result.report_id} ;;
#   }

#   join: v_sno_validation_rule_result {
#     relationship: one_to_many
#     sql_on: ${v_sno_validation_report_result.request_id} = ${v_sno_validation_rule_result.request_id} ;;
#   }

#   join: v_tpm_metrics {
#     relationship: many_to_many
#     sql_on: ${v_sno_opt_viewing_spot_level_pacing.campaign_id} = ${v_tpm_metrics.campaign_id} ;;
#     fields: [tpm_metrics.daypart]
#   }
# }

# explore: v_sno_smartmon_events_forecast_error_metrics {

#   label: "Forecast Error Metrics"

#   sql_always_where: (${v_sno_smartmon_events_forecast_error_metrics.name} = 'forecast_error_metrics') AND
#     ({% if _user_attributes['is_itv_user'] == 'yes' %}${v_sno_smartmon_events_forecast_error_metrics.partner_id} = 5951{% else %} TRUE {% endif %}) ;;
# }
